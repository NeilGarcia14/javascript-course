...
// // console.log(chesterArray[0]); 
// // console.log(chesterArray[1]); 
// // console.log(chesterArray[2]); 
...
// // };
// // console.log(chesterObject)

// // // Property access methods
// // // Do notation
// // console.log(chesterObject.firstName);
// // console.log(chesterObject.lastName);
// // console.log(chesterObject.age);
...
// // const nameKey = "Name";
// // console.log(chesterObject["first" + nameKey]);
// // console.log(chesterObject["last" + nameKey]);

// // // Modifying existing properties
// // chesterObject.job = "Programmer";
// // chesterObject["age"] = 25;
// // console.log(chesterObject);

// // // add new properties
// // chesterObject.location = "Philippines";
// // chesterObject['Twitter'] = "chesterprogrammer";
// // chesterObject.hasDriverLicense = true;
// // console.log(chesterObject); 
...
// // console.log(chester.calcAge(2003));
// // console.log(chester.calcAge(chester.birthYear));
...
// // console.log(chesterImproved.calcAge()); 
// // console.log(chesterImproved.age);
// // console.log(chesterImproved.getSummary());
...
if (userText.length > 50) {
    display.textContent = `DADDY ROB ANO BA!!!`;
